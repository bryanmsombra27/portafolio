            ...
            <div className="md:w-[1200px] h-full flex   flex-col justify-evenly items-center mx-auto  ">
                ...
                <div>
                    <p className="text-2xl text-justify p-9 md:p-0">
                        {english ? heroText.description : "Desde que comence mi viaje en el desarrollo web hace 4 años he desarrollado proyectos personales y 2 años trabajando formalmente para empresas desarrollando aplicaciones web y moviles.A continuacion, puedes examinar los trabajos que he realizado."}
                    </p>
                </div>
