...
const Hero = () => {
    ...
    return (
        ...
        <section className=" h-full   mt-9 flex flex-col items-center space-y-9 mb-10   md:h-[600px] md:mb-0">
            ...
            <h3 className="text-center text-2xl mt-9 max-w-[900px]">{english ? text.description : "Creo API's para la comunicación entre el backend y frontend y  Desarrollo aplicaciones web  o moviles segun las necesidades del proyecto."
            }</h3>
